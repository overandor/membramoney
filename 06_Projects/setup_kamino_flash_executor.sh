...
APP_DIR="${APP_DIR:-kamino-flash-executor}"
...
JUPITER_MAX_PRIORITY_FEE_LAMPORTS=250000
...
MIN_PROFIT_USDC_ATOMS=100000
MIN_EXECUTION_NET_PROFIT_USDC_ATOMS=100000
FLASH_LOAN_FEE_BPS=5
ESTIMATED_NETWORK_FEE_USDC_ATOMS=10000

USDC_MINT=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v
TARGET_MINTS=So11111111111111111111111111111111111111112
BORROW_SIZES_USDC_ATOMS=100000000,500000000,1000000000
...
KAMINO_FLASH_IX_BUILDER_CMD=node ./kamino_build_flash_ix.js

MIN_SOL_BALANCE_LAMPORTS=50000000
MAX_DAILY_EXECUTIONS=20
MAX_CONSECUTIVE_EXECUTOR_FAILURES=3
EXECUTOR_COOLDOWN_MS=15000

SEND_MAX_RETRIES=3
CONFIRMATION_TIMEOUT_MS=45000
CONFIRMATION_POLL_MS=1500
MAX_SIMULATION_LOG_LINES=40

ALLOW_JUPITER_ALTS=false
EOF

cat > kamino_build_flash_ix.js <<'EOF'
#!/usr/bin/env node
...
chmod +x kamino_build_flash_ix.js

cat > kamino_flash_executor.py <<'EOF'
#!/usr/bin/env python3
...
chmod +x kamino_flash_executor.py

cat > package.json <<'EOF'
{
  "name": "kamino-flash-executor-bridge",
  "version": "1.0.0",
  "private": true,
  "type": "commonjs",
  "dependencies": {
...
python kamino_flash_executor.py
EOF
...
echo "  ./run.sh"
echo
echo "Scanner-only is default:"
echo "  EXECUTOR_ENABLED=false"
echo
echo "Simulation execution mode:"
echo "  EXECUTOR_ENABLED=true"
echo "  SIMULATION_ONLY=true"
echo "  REQUIRE_MANUAL_APPROVAL=true"
echo
echo "Do not set SIMULATION_ONLY=false until repeated simulations succeed."
