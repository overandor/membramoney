"""
gate_multi_pair_mm.py - Multi-pair market making with best bid/ask strategy
...
INCLUDE_SYMBOLS = [s.strip().upper() for s in os.getenv("GATE_SYMBOLS", "BTC_USDT,ETH_USDT,SOL_USDT,ENA_USDT").split(",") if s.strip()]
