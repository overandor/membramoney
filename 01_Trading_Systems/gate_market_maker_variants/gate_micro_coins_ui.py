#!/usr/bin/env python3
"""
Gate.io Micro Coins UI - Lists all coins $0-$0.10 for easy copy-paste
...
class GateMicroCoinsUI:
    ...
    def build_ui(self):
        ...
        tk.Label(header, text="🪙 Gate.io Micro Coins", 
    ...
    def filter_coins(self):
        ...
        # Update stats with scan indicator
