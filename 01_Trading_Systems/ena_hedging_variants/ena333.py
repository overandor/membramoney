...
# ======== ======================
PAIR = "PEPE_USDT"  # Replace with a valid symbol (e.g., "BTC_USDT")
LEVERAGE = 20
...
INITIAL_TRADE_SIZE = 1.69     # One contract per order
...
def check_profit_and_close():
    ...
    base_profit_per_contract = 0.01    # e.g., $0.01 net profit per contract
